    ...
    return (
        <>
            <div className="mt-8 flex-1 flex flex-col gap-y-6 overflow-y-auto p-1">
                ...
                <Textarea ref={contentRef} id="noteContentTextarea" className="border-0 bg-white focus-visible:ring-2 flex-1 resize-none" placeholder="내용을 입력하세요." autoComplete="off" defaultValue={selectedNote ? selectedNote.content || '' : ''} />
            </div>
